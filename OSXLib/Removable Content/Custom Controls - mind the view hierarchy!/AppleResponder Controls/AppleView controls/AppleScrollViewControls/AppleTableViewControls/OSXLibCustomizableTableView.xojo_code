#tag Class
Protected Class OSXLibCustomizableTableView
Inherits OSXLibTableView
	#tag Event
		Function InitControl() As Boolean
		  ...
		  if not Raiseevent InitControl then
		    ...
		    mTableViewObject = new AppleCustomizableTableView(mappleobject.frame)
	...
	#tag Property, Flags = &h21
		Private mTableViewObject As AppleCustomizableTableView
	#tag EndProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			...
			End Get
		#tag EndGetter
		TableViewObject As AppleCustomizableTableView
