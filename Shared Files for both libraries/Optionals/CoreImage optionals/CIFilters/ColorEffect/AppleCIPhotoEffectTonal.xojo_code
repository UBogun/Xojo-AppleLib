#tag Class
Protected Class AppleCIPhotoEffectTonal
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E657720434950686F746F456666656374466164652066696C7465722C2073657474696E672074686520696E707574496D6167652E
		Sub Constructor(anImage as iosimage = nil)
		  ...
		  dim mytype as text = kCIPhotoEffectTonal
	...
	#tag Constant, Name = kCIPhotoEffectTonal, Type = Text, Dynamic = False, Default = \"CIPhotoEffectTonal", Scope = Private
	#tag EndConstant
