#tag Class
Protected Class AppleCISepiaTone
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E657720434950686F746F456666656374466164652066696C7465722C2073657474696E672074686520696E707574496D6167652E
		Sub Constructor(anImage as iosimage = nil, Intensity as double = 1.0)
		  ...
		  dim mytype as text = kCISepiaTone
	...
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)), Description = 437265617465732061206E657720434950686F746F4566666563744D6F6E6F2066696C7465722C2073657474696E6720696E707574496D61676520616E6420696E74656E736974792E
		Sub Constructor(anImage as Picture = nil, Intensity as double = 1.0)
		  // Calling the overridden superclass constructor.
		  // Note that this may need modifications if there are multiple constructor choices.
		  // Possible constructor calls:
		  // Constructor() -- From AppleCIFilter
	...
	#tag Constant, Name = kCISepiaTone, Type = Text, Dynamic = False, Default = \"CISepiaTone", Scope = Private
	#tag EndConstant
