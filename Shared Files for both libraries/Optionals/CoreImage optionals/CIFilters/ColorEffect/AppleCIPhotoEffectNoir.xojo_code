#tag Class
Protected Class AppleCIPhotoEffectNoir
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E657720434950686F746F4566666563744E6F69722066696C7465722C2073657474696E672074686520696E707574496D6167652E
		Sub Constructor(anImage as iosimage = nil)
		  ...
		  dim mytype as text = kCIPhotoEffectNoir
	...
	#tag Constant, Name = kCIPhotoEffectNoir, Type = Text, Dynamic = False, Default = \"CIPhotoEffectNoir", Scope = Private
	#tag EndConstant
