#tag Class
Protected Class AppleCIStraightenFilter
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E6577207374726169677468656E2066696C7465722C2073657474696E6720696E707574496D61676520616E6420416E676C6520696E20446567726565732E
		Sub Constructor(anImage as iosImage = nil, Angle As Double = 0)
		  ...
		  dim mytype as text = kCIStraightenFilter 
		  ...
		  InputAngleDegrees = Angle
		  
		  
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)), Description = 437265617465732061206E6577207374726169677468656E2066696C7465722C2073657474696E6720696E707574496D61676520616E6420416E676C6520696E20446567726565732E
		Sub Constructor(anImage as Picture = nil, Angle As Double = 0)
		  // Calling the overridden superclass constructor.
		  // Note that this may need modifications if there are multiple constructor choices.
		  // Possible constructor calls:
		  // Constructor() -- From AppleCIFilter
	...
	#tag Constant, Name = kCIStraightenFilter, Type = Text, Dynamic = False, Default = \"CIStraightenFilter", Scope = Private
	#tag EndConstant
	...
	#tag ViewBehavior
		...
		#tag EndViewProperty
		#tag ViewProperty
			Name="InputAngleDegrees"
			Group="Behavior"
			Type="double"
		#tag EndViewProperty
		#tag ViewProperty
			Name="InputAngleDescription"
			Group="Behavior"
			Type="Text"
		#tag EndViewProperty
		#tag ViewProperty
