#tag Class
Protected Class AppleCIGammaAdjust
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E65772047616D6D612041646A7573746D656E742066696C7465722C2073657474696E6720496E707574496D61676520616E642047616D6D612076616C75652E
		Sub Constructor(inputImage as picture = nil, Gamma as Double = 0.75)
		  ...
		  dim mytype as text = kCIGammaAdjust
	...
	#tag ComputedProperty, Flags = &h0, Description = 5468652067616D6D612076616C75652E2044656661756C7420302E37352E
		#tag Getter
			Get
			  return minputPower
			End Get
		...
		#tag Setter
			...
			End Set
		#tag EndSetter
		InputPower As Double
	#tag EndComputedProperty

	#tag ComputedProperty, Flags = &h0, Description = 546865206C6F63616C697A6564206465736372697074696F6E20666F722074686520696E7075742045562070726F70657274792E2028726561642D6F6E6C7929
		#tag Getter
			Get
			  if FilterAttributes.InputPowerDict <> nil then return FilterAttributes.InputPowerDict.LocalizedDescription
			End Get
		#tag EndGetter
		InputPowerDescription As Text
	#tag EndComputedProperty


	#tag Constant, Name = kCIGammaAdjust, Type = Text, Dynamic = False, Default = \"CIGammaAdjust", Scope = Private
	#tag EndConstant
