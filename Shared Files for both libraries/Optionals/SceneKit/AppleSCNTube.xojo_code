...
Inherits AppleSCNGeometry
	...
	#tag Method, Flags = &h1000, Description = 43726561746573206120747562652067656F6D657472792077697468207468652073706563696669656420696E6E6572207261646975732C206F75746572207261646975732C20616E64206865696768742E
		Sub Constructor(innerRadius As Double, outerRadius As Double, Height As Double)
		  #if Target64Bit
		    Declare function tubeWithInnerRadius Lib SceneKitLibname selector "tubeWithInnerRadius:outerRadius:height:" (id as ptr, innerRadius as double, outerRadius As Double, Height as double) as ptr
		  #elseif Target32Bit
		    Declare function tubeWithInnerRadius Lib SceneKitLibname selector "tubeWithInnerRadius:outerRadius:height:" (id as ptr, innerRadius as single, outerRadius as single, Height as single) as ptr
		  #endif
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  ...
			  if mClassPtr = nil then mClassPtr = FoundationFramework.NSClassFromString ("SCNTube")
			  return mClassPtr
			End Get
		#tag EndGetter
