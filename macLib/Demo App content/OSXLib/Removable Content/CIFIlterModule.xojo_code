...
Protected Module CIFIlterModule
	...
	#tag Method, Flags = &h0, Description = 536574732074686520696E707574696D616765206F6620612066696C74657220746F20746865206F7574707574696D616765206F66207468652070726576696F75732066696C7465722E
		Sub ChainFilters(paramarray Filters() as AppleCIFilter)
		  for q as integer = 1 to filters.Ubound
		    filters(q).ValueForKey(AppleCIFilter.kciinputimagekey) = filters(q-1).OutputCIImage
		  next
		End Sub
	#tag EndMethod
