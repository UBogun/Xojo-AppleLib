#tag Class
Protected Class AppleCIAreaMinimumAlpha
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E6577204349417265614D696E696D756D2066696C7465722C2073657474696E672074686520696E707574496D61676520616E642074686520657874656E742E
		Sub Constructor(anImage as iosimage = nil, x as Double = 0, y as Double = 0, width as Double = 0, height as double = 0)
		  ...
		  dim mytype as text = kCIAreaMinimumAlpha
	...
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)), Description = 437265617465732061206E6577204349417265614D696E696D756D2066696C7465722C2073657474696E672074686520696E707574496D61676520616E642074686520657874656E742E
	...
	#tag Constant, Name = kCIAreaMinimumAlpha, Type = Text, Dynamic = False, Default = \"CIAreaMinimumAlpha", Scope = Private
	#tag EndConstant
