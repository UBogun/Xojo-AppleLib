#tag Class
Protected Class AppleCIAreaMaximum
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E6577204349417265614D6178696D756D2066696C7465722C2073657474696E672074686520696E707574496D61676520616E642074686520657874656E742E
		Sub Constructor(anImage as iosimage = nil, x as Double = 0, y as Double = 0, width as Double = 0, height as double = 0)
		  ...
		  dim mytype as text = kCIAreaMaximum
	...
	#tag Constant, Name = kCIAreaMaximum, Type = Text, Dynamic = False, Default = \"CIAreaMaximum", Scope = Private
	#tag EndConstant
