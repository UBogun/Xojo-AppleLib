#tag Class
Protected Class AppleCIAreaAverage
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E657720436941726561417665726167652066696C7465722C2073657474696E672074686520696E707574496D61676520616E642074686520657874656E742E
		Sub Constructor(anImage as iosimage = nil, x as Double = 0, y as Double = 0, width as Double = 0, height as double = 0)
		  ...
		  dim mytype as text = kCIAreaAverage
	...
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)), Description = 437265617465732061206E657720436941726561417665726167652066696C7465722C2073657474696E672074686520696E707574496D61676520616E642074686520657874656E742E
	...
	#tag Constant, Name = kCIAreaAverage, Type = Text, Dynamic = False, Default = \"CIAreaAverage", Scope = Private
	#tag EndConstant
