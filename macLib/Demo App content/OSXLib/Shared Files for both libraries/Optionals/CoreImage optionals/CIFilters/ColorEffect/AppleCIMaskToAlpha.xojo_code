#tag Class
Protected Class AppleCIMaskToAlpha
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E6577204369436F6C6F72496E766572742066696C7465722C2073657474696E672074686520696E707574496D6167652077686963682073686F756C6420626520677261797363616C652E20426C61636B2077696C6C206265636F6D65207472616E73706172656E742E
		Sub Constructor(anImage as iosimage = nil)
		  ...
		  dim mytype as text = kCIMaskToAlpha
	...
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)), Description = 437265617465732061206E6577204369436F6C6F72496E766572742066696C7465722C2073657474696E672074686520696E707574496D6167652077686963682073686F756C6420626520677261797363616C652E20426C61636B2077696C6C206265636F6D65207472616E73706172656E742E
		Sub Constructor(anImage as Picture = nil)
		  // Calling the overridden superclass constructor.
		  // Note that this may need modifications if there are multiple constructor choices.
		  // Possible constructor calls:
		  // Constructor() -- From AppleCIFilter
	...
	#tag Constant, Name = kCIMaskToAlpha, Type = Text, Dynamic = False, Default = \"CIMaskToAlpha", Scope = Private
	#tag EndConstant
