#tag Class
Protected Class AppleCIColorMonochrome
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E6577204D6F6E6F6368726F6D652066696C7465722C2073657474696E6720696E707574496D6167652C2074686520636F6C6F7220746F2074696E742074686520696D61676520616E64207468652065666665637420696E74656E736974792E
		Sub Constructor(anImage as iosimage = nil, TintColor As Color, Intensity as Double = 1.0)
		  ...
		  dim mytype as text = kCIColorMonochrome
		  ...
		  InputColor = new AppleCIColor(TintColor)
	...
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)), Description = 437265617465732061206E6577204D6F6E6F6368726F6D652066696C7465722C2073657474696E6720696E707574496D6167652C2074686520636F6C6F7220746F2074696E742074686520696D61676520616E64207468652065666665637420696E74656E736974792E
		Sub Constructor(anImage as Picture = nil,  TintColor As Color, Intensity as Double = 1.0)
		  // Calling the overridden superclass constructor.
		  // Note that this may need modifications if there are multiple constructor choices.
		  // Possible constructor calls:
		  // Constructor() -- From AppleCIFilter
	...
	#tag ComputedProperty, Flags = &h0, Description = 54686520636F6C6F7220746F2074696E742074686520696D61676520696E2E
		#tag Getter
			Get
	...
	#tag Constant, Name = kCIColorMonochrome, Type = Text, Dynamic = False, Default = \"CIColorMonochrome", Scope = Private
	#tag EndConstant
