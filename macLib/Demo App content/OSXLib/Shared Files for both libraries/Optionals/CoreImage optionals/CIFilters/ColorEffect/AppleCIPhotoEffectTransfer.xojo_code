#tag Class
Protected Class AppleCIPhotoEffectTransfer
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E657720434950686F746F456666656374466164652066696C7465722C2073657474696E672074686520696E707574496D6167652E
		Sub Constructor(anImage as iosimage = nil)
		  ...
		  dim mytype as text = kCIPhotoEffectTransfer
	...
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)), Description = 437265617465732061206E657720434950686F746F4566666563744D6F6E6F2066696C7465722C2073657474696E672074686520696E707574496D6167652E
	...
	#tag Constant, Name = kCIPhotoEffectTransfer, Type = Text, Dynamic = False, Default = \"CIPhotoEffectTransfer", Scope = Private
	#tag EndConstant
