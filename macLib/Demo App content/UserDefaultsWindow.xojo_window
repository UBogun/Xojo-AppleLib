#tag Window
Begin Window UserDefaultsWindow
   BackColor       =   &cFFFFFF00
   Backdrop        =   0
   CloseButton     =   True
   Compatibility   =   ""
...
#tag Events TextField1
	#tag Event
		Sub TextChange()
		  AppleUserDefaults1.TextValue ("TestString") = me.Text
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events AppleUserDefaults1
	#tag Event , Description = 4669726573207768656E2061206368616E6765206973206D61646520746F2064656661756C747320696E20612070657273697374656E7420646F6D61696E2E
		Sub DefaultsChanged()
		  ...
		  dim at as new AppleAnimationContext
		  at.Duration = 1
		  label2.AppleObject.Animator.Alpha = 0
		End Sub
	#tag EndEvent
	#tag Event
		Sub Open()
		  TextField1.text = me.TextValue("TestString")
		  dim a as AppleDictionary = me.DictionaryRepresentation
		  for q as integer = 0 to a.Allkeys.Count -1
		    dim t as text = a.Allkeys.TextAtIndex(q)
		    Listbox1.AddRow t
		  next
...
#tag Events PushButton1
	#tag Event
		Sub Action()
		  AppleUserDefaults1.RemoveObject("TestString")
		  TextField1.Text = ""
		End Sub
	#tag EndEvent
#tag EndEvents
