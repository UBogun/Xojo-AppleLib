...
Inherits AppleLayoutAnchor
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function constraintEqualToAnchorMultiplier Lib appkitlibname Selector "constraintEqualToAnchor:multiplier:" (id as ptr, anchor as ptr, multiplier as CGFloat) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function constraintEqualToAnchorMultiplierConstant Lib appkitlibname Selector "constraintEqualToAnchor:multiplier:constant:" (id as ptr, anchor as ptr, multiplier as CGFloat, constant as CGFloat) As Ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function constraintEqualToConstant Lib appkitlibname Selector "constraintEqualToConstant:" (id as ptr, value as cgfloat) As Ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function constraintGreaterThanOrEqualToAnchor Lib appkitlibname Selector "constraintGreaterThanOrEqualToAnchor:multiplier:" (id as ptr, anchor as ptr, multiplier as CGFloat) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function constraintGreaterThanOrEqualToAnchorConstant Lib appkitlibname Selector "constraintGreaterThanOrEqualToAnchor:multiplier:constant:" (id as ptr, anchor as ptr, multiplier as cgfloat, constant as CGFloat) As Ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function constraintGreaterThanOrEqualToConstant Lib appkitlibname Selector "constraintGreaterThanOrEqualToConstant:" (id as ptr, value as cgfloat) As Ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function constraintLessThanOrEqualToAnchor Lib appkitlibname Selector "constraintLessThanOrEqualToAnchor:multiplier:" (id as ptr, anchor as ptr, multiplier as CGFloat) As Ptr
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h1
		Protected Declare Function constraintLessThanOrEqualToAnchorConstant Lib appkitlibname Selector "constraintLessThanOrEqualToAnchor:multiplier:constant:" (id as ptr, anchor as ptr, multiplier as cgfloat, constant as CGFloat) As Ptr
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h1
		Protected Declare Function constraintLessThanOrEqualToConstant Lib appkitlibname Selector "constraintLessThanOrEqualToConstant:" (id as ptr, value as cgfloat) As Ptr
	#tag EndExternalMethod
