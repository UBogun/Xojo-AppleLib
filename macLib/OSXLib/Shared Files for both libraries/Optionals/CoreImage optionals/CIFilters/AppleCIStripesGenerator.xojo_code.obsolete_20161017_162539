#tag Class
Protected Class AppleCIStripesGenerator
Inherits AppleCIFilter
	#tag Method, Flags = &h1000, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit)) or  (TargetIOS and (Target32Bit or Target64Bit)), Description = 437265617465732061206E657720737472697065732067656E657261746F722C2073657474696E67207468652063656E7465722C20636F6C6F72732C207368617072706E65737320616E64207769647468206F662074686520737175617265732E
		Sub Constructor(CenterX as Double = 150, CenterY as Double = 150, Color0 as color = &c00000000, Color1 as Color = &cFFFFFF00, Width as Double = 80, Sharpness as Double = 1.0)
		  ...
		  dim mytype as text = kCIStripesGenerator
	...
	#tag Constant, Name = kCIStripesGenerator, Type = Text, Dynamic = False, Default = \"CIStripesGenerator", Scope = Private
	#tag EndConstant
