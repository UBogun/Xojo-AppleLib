...
Inherits OSXLibView
	...
	#tag Event , Description = 5573652074686973206576656E7420746F206372656174652043616E76617320737562636C61737365732E2052657475726E207472756520696620796F7520686176652073657420746865206D4170706C654F626A6563742070726F706572747920746F2061206E657720636F6E74726F6C20766965772E
		Function InitControl() As AppleView
		  ...
		  dim obj as new ApplescnView (AppleObject.fromControl(self).Frame, RenderingAPI) // Declaring the new Applecontrol, in this case a SKview.
	...
	#tag Method, Flags = &h0
		Sub AttachHandlers(obj as applescnview)
		  ...
		  AddHandler obj.didupdatecontact, addressof InformOnDidUpdateContact
	...
	#tag Method, Flags = &h21
		Private Sub informonDidRenderScene(view as AppleSCNView, scene as appleSCNscene, UpdateTime as double)
		  RaiseEvent DidRenderScene (scene, updatetime)
		  #Pragma unused view
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub informOnDidUpdateContact(view as ApplescnView,PWorld As AppleSCNPhysicsWorld, contact as AppleSCNPhysicsContact)
	...
	#tag Method, Flags = &h0, Description = 52656E64657273207468652076696577E2809973207363656E6520696E746F2061206E657720696D616765206F626A6563742E
		Function Snapshot() As Picture
		  return AppleObject.Snapshot.toPicture
		End Function
	#tag EndMethod
	...
	#tag Hook, Flags = &h0, Description = 4669726573207768656E206120436F6E74616374206265747765656E2074776F206E6F6465732077697468206D61746368696E6720436F6C6C6973696F6E4269746D61736B7320686173206368616E67656420627574206E6F7420656E6465642E
		Event ContactUpdated(World as AppleSCNPhysicsWorld, Contact As AppleSCNPhysicsContact)
	#tag EndHook
	...
	#tag Property, Flags = &h0, Description = 5468652052656E646572696E672041504920746F2075732E2050726F706572747920666F722074686520696E697469616C697A65722E
		RenderingAPI As SceneKitFrameWork.SCNRenderingAPIMacOS = SceneKitFrameWork.SCNRenderingAPImacos.metal
	#tag EndProperty
	...
	#tag ViewBehavior
		...
		#tag ViewProperty
			...
			Visible=true
			Group="Behavior"
			InitialValue="SceneKitFrameWork.SCNRenderingAPImacos.metal"
